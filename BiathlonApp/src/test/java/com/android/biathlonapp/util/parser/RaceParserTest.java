...
public class RaceParserTest {
    ...
    public void setUp() {
        // Prepare data
        String[] firstRow = {"2016.02.09 AD at 12:08:56 MSK", "17.5", "Men's sprint"};
        String[] secondRow = {"2018.02.09 AD at 12:08:56 MSK", "12.5", "Women's sprint"};
        ...
        Race firstRace = new Race(firstDate, 17.5, "Men's sprint");
        Race secondRace = new Race(secondDate, 12.5, "Women's sprint");
        expected.add(firstRace);
        expected.add(secondRace);
        // Create string parser
        raceParser = new RaceParser(input);
    }
